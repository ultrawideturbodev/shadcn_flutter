...
class SliderValue {
  ...
  SliderValue roundToDivisions(int divisions) {
    ...
    return SliderValue.ranged(
        (_start! * divisions).round() / divisions, (_end * divisions).round() / divisions);
  }
}
...
class _SliderState extends State<Slider> with FormValueSupplier<SliderValue, Slider> {
            ...
            return GestureDetector(
              onTapDown: widget.value.isRanged
                  ...
                  : (details) {
                      ...
                      SliderValue newSliderValue =
                          SliderValue.single(newValue * (widget.max - widget.min) + widget.min);
                      _dispatchValueChangeStart(newSliderValue);
                      _dispatchValueChange(newSliderValue);
                      _dispatchValueChangeEnd(newSliderValue);
                      setState(() {
              ...
              onHorizontalDragStart: (details) {
                ...
                if (_currentValue.isRanged) {
                  ...
                  SliderValue newSliderValue =
                      SliderValue.single(value * (widget.max - widget.min) + widget.min);
                  _dispatchValueChangeStart(newSliderValue);
                }
              },
              onHorizontalDragUpdate: widget.value.isRanged
                  ? (details) {
                      ...
                      if (_moveStart) {
                        ...
                        if (widget.divisions != null) {
                          sliderStart =
                              (sliderStart * widget.divisions!).round() / widget.divisions!;
                  ...
                  : (details) {
                      ...
                      var newSliderValue =
                          SliderValue.single(sliderValue * (widget.max - widget.min) + widget.min);
                      _dispatchValueChange(newSliderValue);
                      setState(() {
                        _currentValue = SliderValue.single(newValue);
                      });
              ...
              onHorizontalDragEnd: (details) {
                ...
                if (_currentValue.isRanged) {
                  ...
                  _dispatchValueChangeEnd(SliderValue.single(
                      (_currentValue.value * (widget.max - widget.min) + widget.min)));
                }
                setState(() {});
              },
              child: MouseRegion(
  ...
  Widget buildSingleSlider(BuildContext context, BoxConstraints constraints, ThemeData theme) {
    return Stack(
  ...
  Widget buildHint(BuildContext context, BoxConstraints constraints, ThemeData theme) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
    ...
    return AnimatedValueBuilder(
        ...
        builder: (context, hintValue, _) {
          ...
          var right =
              (1 - (newEnd - widget.min) / (widget.max - widget.min)) * constraints.maxWidth;
          return Positioned(
  ...
  Widget buildTrackValue(BuildContext context, BoxConstraints constraints, ThemeData theme) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
  ...
  Widget buildTrackBar(BuildContext context, BoxConstraints constraints, ThemeData theme) {
    final theme = Theme.of(context);
    final scaling = theme.scaling;
    return Positioned(
      left: 0,
  ...
  Widget buildRangedSlider(BuildContext context, BoxConstraints constraints, ThemeData theme) {
    return Stack(
      clipBehavior: Clip.none,
      children: [
        buildTrackBar(context, constraints, theme),
